...
# ================================================================================
#       OpenHarmony OHScrcpy 一键打包脚本 - Installer方式 (Linux/Mac)
# ================================================================================
#
# 功能：自动完成Installer打包的所有步骤（准备→打包→制作安装包→清理）
#
# 流程：
#   [步骤1/6] 检查环境依赖
#   [步骤2/6] 执行prepare_for_installer.sh
#   [步骤3/6] 执行make_ohscrcpy_executer_onedir.sh
#   [步骤4/6] 执行make_ohscrcpy_installer.sh
#   [步骤5/6] 显示输出结果
#   [步骤6/6] 执行clear_for_installer.sh
#
...
echo "+++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 1/6] 检查环境依赖...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++"
echo ""
...
echo "+++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 2/6] 准备打包资源...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++"
echo ""

cd "$SCRIPT_DIR/Installer"
if [ ! -f "prepare_for_installer.sh" ]; then
    echo "-------------------------------------------------------------"
    echo -e "\033[31m[错误] 未找到 prepare_for_installer.sh\033[0m"
    echo "-------------------------------------------------------------"
    cleanup_on_error
fi

chmod +x prepare_for_installer.sh
...
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 3/6] 执行PyInstaller打包（onedir模式）...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo ""

cd "$SCRIPT_DIR/Installer"
if [ ! -f "make_ohscrcpy_executer_onedir.sh" ]; then
    echo "-------------------------------------------------------------"
    echo -e "\033[31m[错误] 未找到 make_ohscrcpy_executer_onedir.sh\033[0m"
    echo "-------------------------------------------------------------"
    cleanup_on_error
fi

chmod +x make_ohscrcpy_executer_onedir.sh
...
echo "+++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 4/6] 制作安装包...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++"
echo ""

cd "$SCRIPT_DIR/Installer"
if [ ! -f "make_ohscrcpy_installer.sh" ]; then
    echo "-------------------------------------------------------------"
    echo -e "\033[31m[错误] 未找到 make_ohscrcpy_installer.sh\033[0m"
    echo "-------------------------------------------------------------"
    cleanup_on_error
fi

chmod +x make_ohscrcpy_installer.sh
...
echo ""
echo -e "\033[32m[完成] 安装包制作完成\033[0m"
echo ""

echo "+++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 5/6] 显示输出结果...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++"
echo ""
...
OUTPUT_DIR="$SCRIPT_DIR/Installer/output/${OS_TYPE}/${ARCH}"
echo "[信息] 输出目录: $OUTPUT_DIR"
echo ""

if [ -d "$OUTPUT_DIR" ]; then
    echo "生成的文件："
    ls -lh "$OUTPUT_DIR" | grep -E "OHScrcpy|\.zip|Setup|hash\.txt"
else
    echo "-------------------------------------------------------------"
...
echo "+++++++++++++++++++++++++++++++++++++++"
echo -e "\033[33m[步骤 6/6] 清理临时资源文件...\033[0m"
echo "+++++++++++++++++++++++++++++++++++++++"
echo ""
...
echo -e "\033[32m============================================\033[0m"
echo -e "\033[32m Installer打包完成！\033[0m"
echo -e "\033[32m============================================\033[0m"
echo ""
echo "版本: $VERSION"
...
echo ""
echo "使用方法："
echo "  解压 OHScrcpy_Setup_${OS_TYPE}_${ARCH}_${VERSION}.zip"
echo "  执行 install_ohscrcpy.sh 安装"
