...
REM
REM 使用方法：
REM   1. 在Package目录下执行：clear_for_installer.bat
REM   2. 脚本自动清理所有资源文件
REM
REM 清理内容：
...
title OpenHarmony OHScrcpy Installer资源清理脚本
color 0a
echo ==================================================================
echo      OpenHarmony OHScrcpy Installer资源清理脚本（Windows平台）    
echo ==================================================================
echo.
...
if exist docs\CHANGELOG.txt del docs\CHANGELOG.txt
