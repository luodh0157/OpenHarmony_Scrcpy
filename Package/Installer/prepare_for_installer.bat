...
REM ================================================================================
REM
REM 功能：自动从项目根目录拷贝所需资源到Package\Installer目录
REM
REM 使用方法：
REM   1. 在Package目录下执行：prepare_for_installer.bat
REM   2. 脚本自动拷贝所有必需文件
REM   3. 完成后进入Package\Installer目录执行打包脚本
REM
REM 拷贝内容：
REM   - Client目录：main.py + core/video/gui/utils/config/hdc
REM   - Server文件：ohscrcpy_server + ohscrcpy_server.cfg
REM   - CHANGELOG.txt：拷贝到docs目录
REM
REM 输出位置：
REM   - Package\Installer\（当前目录）
REM
REM 下一步操作：
REM   - cd Package\Installer
REM   - make_ohscrcpy_executer_onedir.bat
REM   - make_ohscrcpy_installer.bat
REM
REM ================================================================================
