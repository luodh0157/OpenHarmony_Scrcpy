...
# ================================================================================
#       OpenHarmony OHScrcpy 自动准备资源脚本 - Executer打包方式 (Linux/Mac)
# ================================================================================
#
# 功能：自动从项目根目录拷贝所需资源到Package/Executer目录
#
# 使用方法：
#   1. 在Package目录下执行：./prepare_for_executer.sh
#   2. 脚本自动拷贝所有必需文件
#   3. 完成后进入Package/Executer目录执行打包脚本
#
# 拷贝内容：
...
echo -e "\033[32m     OpenHarmony OHScrcpy Executer资源准备脚本（Linux/Mac平台）    \033[0m"
echo -e "\033[32m===================================================================\033[0m"
echo ""
